...
export const QuizPanel = memo(function QuizPanel({ quiz, alreadyCompleted, onComplete }: QuizPanelProps) {
  ...
  }, [answered, quiz.options, onComplete])
  ...
  return (
    <div className="quiz-section">
      ...
      <div className="options-grid" role="group" aria-label="Antwortoptionen">
      ...
      {feedback && answered !== null && !quiz.options[answered].isCorrect && (
        <div className="callout error" style={{ marginTop: 16 }} role="alert">
